...
import com.gendeathrow.hatchery.network.MessageTileDataParameter;
import com.gendeathrow.hatchery.network.MessageTileDataParameterUpdate;
...
public class TileDataManager {
    ...
    public static <T> void setParameter(TileDataParameter<T> parameter, T value) {
        Hatchery.instance.network.sendToServer(new MessageTileDataParameterUpdate(parameter, value));
    }
    ...
    public void sendParameter(EntityPlayerMP player, TileDataParameter<?> parameter) {
        Hatchery.instance.network.sendTo(new MessageTileDataParameter(tile, parameter), player);
    }
